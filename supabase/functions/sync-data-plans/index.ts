...
const ALBARKA_STATIC_PLANS: Record<string, any[]> = {
  mtn: [
    ...
    { plan_id: 80, plan_type: 'GIFTING', plan_name: '2GB', amount: 490, validity: '30 days' },
    { plan_id: 81, plan_type: 'GIFTING', plan_name: '3GB', amount: 735, validity: '30 days' },
    { plan_id: 82, plan_type: 'GIFTING', plan_name: '5GB', amount: 1250, validity: '30 days' },
