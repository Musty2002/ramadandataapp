        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Welcome to Ramadan Data App. Ramadan Data App is committed to protecting your personal information and your right to privacy. This Privacy Policy explains how Ramadan Data App collects, uses, discloses, and safeguards your information when you use the mobile application and its services, including but not limited to data bundles, airtime top-up, electricity bill payments, cable TV subscriptions, exam result-checker PINs, wallet funding, peer-to-peer transfers, and referral programs.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-xl font-semibold text-foreground mb-4">2. Information Collected</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              The App collects information that you provide directly and information generated automatically when you use the services:
            </p>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
              ...
              <li><strong>Payment Information:</strong> Wallet balance, virtual bank account details (created through a payment partner), and transaction history. Credit/debit card details are not stored directly.</li>
              ...
              <li><strong>Identity Verification:</strong> BVN/NIN information if you choose to use the identity verification service (when available).</li>
            </ul>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
              ...
              <li><strong>Clipboard Data:</strong> The App accesses clipboard only when you explicitly tap "Copy" for account numbers, referral codes, or exam PINs. Clipboard data is never read in the background.</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
              <li>Provide, maintain, and improve services including data, airtime, electricity, TV, and exam PIN purchases</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Ramadan Data App implements multiple layers of security to protect your account:
            </p>
            <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
              ...
              <li><strong>Biometric Authentication:</strong> Optional fingerprint or face recognition for login and transaction authorization, processed entirely on your device using the device's secure enclave.</li>
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              Biometric data is processed locally on your device and is never transmitted to or stored on external servers.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Your information may be shared with the following parties solely for the purpose of providing the App's services:
            </p>
            <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
              ...
              <li><strong>VTU Service Providers:</strong> Third-party API providers (for data, airtime, electricity, cable TV, and exam PINs) who require minimal transaction details to fulfill orders.</li>
              ...
              <li><strong>Legal Requirements:</strong> When required by law, regulation, or to protect rights, safety, and property.</li>
              <li><strong>Business Transfers:</strong> In connection with any merger, sale, or acquisition of company assets.</li>
            </ul>
            <p className="text-muted-foreground leading-relaxed mt-4">
              Your personal information is never sold, traded, or rented to third parties for marketing purposes.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Push notifications are used to inform you about transaction statuses (successful, failed, or pending), wallet credit alerts, referral bonuses, promotional offers, and important account updates. You can manage notification preferences in your device settings at any time. Your device push token is stored securely to deliver these notifications.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              For optimal app performance and offline functionality, certain data is stored locally on your device, including cached profile data, wallet balance, recent transaction history, and authentication tokens. This data is stored using your device's secure storage mechanisms. Servers are secured with industry-standard encryption, access controls, and regular security assessments. However, no method of electronic transmission or storage is 100% secure.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Your personal information is retained for as long as necessary to fulfill the purposes for which it was collected, including to satisfy legal, accounting, or reporting requirements. Transaction records are retained for a minimum of 7 years for compliance purposes. Locally stored data (PIN, biometric preferences, cached data) is removed when you uninstall the App or explicitly clear app data.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              You may request deletion of your account and associated data by visiting the{' '}
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              The App integrates with third-party services to provide functionality. These services have their own privacy policies that govern how they handle your data. You are encouraged to review their policies. Key third-party services include payment gateway providers for virtual account creation and funding, VTU API providers for airtime, data, and utility services, and cloud infrastructure providers for secure data hosting.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              The App's services are not intended for children under 13 years of age. Personal information from children under 13 is not knowingly collected. If you are a parent or guardian and believe your child has provided personal information, please contact support immediately and steps will be taken to delete such information.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              This Privacy Policy may be updated from time to time to reflect changes in practices, services, or legal requirements. Significant changes will be communicated through in-app notifications or by updating the "Last updated" date. Continued use of the App after changes constitutes your acceptance of the revised policy. You are advised to review this Privacy Policy periodically.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              If you have any questions about this Privacy Policy, data practices, or wish to exercise your data rights, please reach out:
            </p>
