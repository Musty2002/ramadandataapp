...
const supportOptions = [
  ...
  },
  {
    icon: Phone,
    title: 'Call Us',
    description: '09068502050',
    action: () => window.open('tel:09068502050', '_blank'),
    color: 'text-blue-500',
  ...
  },
  {
    icon: Mail,
    title: 'Email Support',
    description: 'ramadandataapp@gmail.com',
    action: () => window.open('mailto:ramadandataapp@gmail.com', '_blank'),
